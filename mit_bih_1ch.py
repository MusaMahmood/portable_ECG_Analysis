...
# Import Data:
# x_tt, y_tt = tfs.load_data_v2('data/dummy_4s', [seq_length, 2], y_shape, 'relevant_data', 'Y')
x_tt, y_tt = tfs.load_data_v2('data/mit_bih_tlabeled_2ch_w8s_fixed', [seq_length, 2], y_shape, 'relevant_data', 'Y')
if num_channels < 2:
...
# xx_flex, y_flex = tfs.load_data_v2('data/flexEcg_4s_normal', [seq_length, 1], [1], 'relevant_data', 'Y')
